...
const FrontPage = {
    ...
    <div>  
        ...
        <section  class="section-features js--section-features">
            ...
            <div class="group section row">    
                <div class="col span_1_of_4 test">
                    <ion-icon class="ion-icon" name="body"></ion-icon>
                ...
                <div class="col span_1_of_4 test">
                    <ion-icon id="hu" class="ion-icon" name="hand"></ion-icon>
                ...
                <div class="col span_1_of_4 test">
                    <ion-icon class="ion-icon" name="fitness"></ion-icon>
                ...
                <div class="col span_1_of_4 test">
                    <ion-icon class="ion-icon" name="restaurant"></ion-icon>
        ...
        <section class="last-class">
            <div class="row">    
                ...
                <div class="group section row">
                        ...
                        <div class="col span_1_of_2">
                            <h3 class="intro">Oslo Kvadraturen</h3>
                            <p>Prinsens gate 9</p>
                            <p>0153 Oslo</p>
        ...
        <div class="footer">
            <p>Copyright &copy; 2019 by Best Team In Grensesnitt</p>
        </div>
    </div>
